...
const categories = Array.from(
  new Set(["All", ...prompts.map((p) => p.category)])
).sort((a, b) => {
          ...
          return (
            <Button
              ...
              className={`rounded-lg transition-all duration-200 cursor-pointer
                ...
                hover:${colors.bg.replace(
                  "600",
                  "700"
                )} focus:${colors.bg.replace("600", "700")}
              `}
            >
              {category}
            </Button>
          ...
          return (
            ...
            >
              <CardContent className="py-0 px-5 pb-12 pt-10">
                ...
                <div
                  className={`absolute bottom-5 left-4 px-2 py-1 text-xs font-semibold rounded-full cursor-pointer ${
                    categoryColors[prompt.category]?.bg ||
                    "bg-gray-200 dark:bg-gray-700"
                  } ${
                    categoryColors[prompt.category]?.text ||
